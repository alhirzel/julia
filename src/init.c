...
# else
    ...
    bootstrap_task.value.ptls = jl_init_threadtls(0);
    ...
    jl_init_root_task(bootstrap_task.value.ptls, stack_lo, stack_hi);
    jl_task_t *ct = jl_current_task;
    assert(ct != &bootstrap_task.value);
